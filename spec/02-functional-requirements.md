...
- **FR-105** Each saved email template must define its required From display name. Initial, reminder, resend, preview, and test-send operations must use the selected template's display name.
